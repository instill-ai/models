...
class DocumentProcessor:
    ...
    async def _process_document(self, base64_content: str) -> Tuple[List[str], List[str], List[int]]:
        """Process document in batches using a while loop to avoid OOM issues"""

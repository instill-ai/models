...
class GLM5:
    def __init__(self):
        ...
        cmd = [
            ...
            "--split-mode", os.environ.get("SPLIT_MODE", "row"),
            "--ctx-size", os.environ.get("N_CTX", "16384"),
            "--flash-attn", "on",
            "--batch-size", os.environ.get("BATCH_SIZE", "2048"),
            "--ubatch-size", os.environ.get("UBATCH_SIZE", "2048"),
            "--cache-type-k", os.environ.get("KV_CACHE_K", "q4_0"),
            "--cache-type-v", os.environ.get("KV_CACHE_V", "q4_0"),
            "--parallel", os.environ.get("PARALLEL_REQUESTS", "4"),
            "--cont-batching",
            "--reasoning", "off",
